...
| docs/ops/vpn-access-fix.md | Why VPN clients can't reach a Windows-container-published port and the netsh portproxy + iphlpsvc workaround. Includes diagnostic checklist, rollback, and the cleaner long-term option of running AITestCrew as a native exe. |
